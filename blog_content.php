<div>
    <div class="articles_div" id=""><?php if(have_posts()) : ?>
        <?php while(have_posts()) : the_post(); ?>
            <div class="post article text-center"> <h2><a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
                <?php the_title(); ?></a></h2> <p class="postmetadata"> <div class="post_content"> <?php the_content(); ?> </div>
